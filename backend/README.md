...
`docs/JARVIS-API.md` section 26 has the routes, the words and the known gaps.
...
- The manner setting (warm / plain) and the "stop everything" hotkey were
  built at the same time; the hooks are `jarvis_focus.MANNER_SOURCE` and
