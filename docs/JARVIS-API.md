...
an alarm or a morning briefing; setting it up sends nothing anywhere, and
deleting it is immediate" (`briefing.patch`, 2026-09-25; before it, "sets up
a reminder or alarm that repeats, on this PC; nothing is sent anywhere, and
...
- **The initiative engine and the digest are not hooked in.** The engine's
  ...
  as new kinds (`register_kind`), not as schedulers of their own. The
  morning briefing is the first to do so (section 22).
