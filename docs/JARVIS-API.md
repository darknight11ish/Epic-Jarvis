...
itself when the model answering cannot see it (section 36). Both apps read
...
## 36. The words in a picture, read on the PC (added 2026-09-26)
...
## 38. Smartwatch notifications (added 2026-09-27)
