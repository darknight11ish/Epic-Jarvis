 ...
 *   email addresses wait for a yes even with the
...
export const SENSITIVE_DETAIL =
  ...
  "asks you first. Passwords, PINs, account and ID numbers, birthdays, phone " +
  "numbers and email addresses always wait for your yes.";
