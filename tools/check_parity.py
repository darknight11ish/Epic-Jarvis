...
CLASSIFICATION = {
    ...
    "/api/schedule/add": ("ported", "One to-do item, in the owner's own words. Both apps add only a to-do item here (brain_schedule_add_todo, JarvisRuntime.addTodo), held on a stale link; timers and reminders are set by saying or typing them to Jarvis, and a repeating one's approval card is raised by the PC."),
