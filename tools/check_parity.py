...
CLASSIFICATION = {
    ...
    "/api/focus": ("ported", "Focus sessions (backend/focus.patch, jarvis_focus.py; the owner's decision of 2026-09-25; JARVIS-API section 26): the countdown, booleans and counts, and the last report card - never what was in front on the PC. A read, not held on a stale link. Desktop: Brain -> Work -> Focus session and the widget's countdown that tints on a drift (brain/focus.rs focus_status). Phone: Mind, Focus session (FocusPlate.kt, net/Focus.kt)."),
