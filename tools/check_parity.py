...
CLASSIFICATION = {
    ...
    "/api/memory/learning/sensitive": ("ported", "\"Also remember sensitive topics automatically\" (off by default): ON is one approval card (learning_sensitive_enable), OFF is immediate. The same holds as the other switch."),
